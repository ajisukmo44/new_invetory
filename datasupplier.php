...
<div class="card-header">
  ...
  <table class="table table-sm table-hover table-striped table-bordered p-2" id="dataTable" style="font-size:14px">
  <thead>
    <tr class="bg-secondary text-white">
      <td width="4%" class="text-center p-2">No</td>
      <td width="10%" class="p-2">ID Supplier</td>
      <td width="28%" class="p-2">Nama Supplier</td>
      <td width="16%" class="p-2">No Telepon</td>
      <td width="35%" class="p-2">Alamat Supplier</td>
      
      <td width="7%" class="text-right p-2">Tindakan&nbsp;&nbsp;&nbsp;&nbsp;</td>
    </tr>
  </thead>
  <tbody>
  <?php
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            <td><?= $alt ?></td>
            <td  class="text-right">
            <a href="#" data-toggle="modal" data-target="#editModal" data-id="<?= $id; ?>" class="btn btn-secondary btn-sm "><i class="fa fa-edit"></i></a><a href="aksi/deletesupplier.php?id=<?= $id; ?>" onclick="return confirm('Anda yakin mau menghapus data ini ?')" class="btn btn-danger btn-sm ml-1 mr-2"><i class=" fa fa-times"></i></a>
            </td>
            </tr>
        <?php } ?>
  </tbody>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h6><b>TAMBAH DATA SUPPLIER </b></h6>
