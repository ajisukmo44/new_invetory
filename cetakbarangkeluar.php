...
<!-- query join tabel -->
    ...
    <table class="tabel2 table-responsive" cellspacing="0" cellpadding="0" align="center">
        <tr>
            <col width="350">
            <td align="left">
            <p style="margin-left:-7px" ><strong> Laporan :</strong> Barang Keluar</p>
            </td>
            <col width="350">
            <td>
            <p align="right">
            <strong>Periode :</strong> <?= date('d/m/Y', strtotime($taw)); ?> - <?= date('d/m/Y', strtotime($tak)); ?></p>
             </td>
